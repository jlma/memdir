...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { fkMemberID: @phone.fkMemberID, phoneNumber: @phone.phoneNumber, whichPhone: @phone.whichPhone }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { fkMemberID: @phone.fkMemberID, phoneNumber: @phone.phoneNumber, whichPhone: @phone.whichPhone }
    assert_redirected_to phone_path(assigns(:phone))
  end
